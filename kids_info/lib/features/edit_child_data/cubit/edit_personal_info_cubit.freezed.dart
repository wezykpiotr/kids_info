...
abstract class $EditPersonalInfoStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {List<EditPersonalInfoModel> items, Status status, String? errorMessage});
}
...
class _$_EditPersonalInfoState implements _EditPersonalInfoState {
  ...
  @override
  String toString() {
    return 'EditPersonalInfoState(items: $items, status: $status, errorMessage: $errorMessage)';
  }
...
abstract class _EditPersonalInfoState implements EditPersonalInfoState {
  factory _EditPersonalInfoState(
      ...
      final Status status,
      final String? errorMessage}) = _$_EditPersonalInfoState;
